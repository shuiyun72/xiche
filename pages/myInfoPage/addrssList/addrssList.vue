			...
			<view class="row " v-for="(row,index) in 3" :key="index" @click="selectAddr(row)">
				<view class="row-top flex-direction flex">
					<view class="top-one flex">
						<view class="item" v-for="(item,k) in 4">
							<image src="../../../static/tingcc.png"></image>
							<text class="fs-32 fw-bold cl-333">12号停车位</text>
						</view>
					</view>
					<view class="top-two fs-26 cl-666">
地址：郑州市高新区科学大道升龙又一城D区5号楼区科学大道升龙又一城D区5号楼
