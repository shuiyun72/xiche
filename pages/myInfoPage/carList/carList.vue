		...
		<view class="list">
			...
			<view class="row " v-for="(row,index) in 3" :key="index" @click="selectAddr(row)">
				<view class="row-top">
					<view class="top-one">
						<view class="img">
							<image src="../../../static/heis.png"></image>
						</view>
						<view class="car-num fw-bold cl-333 fs-32 mr-lt10 flex flex-direction">
							<text class="mr-bt30">车牌号</text>
							<text>颜色</text>
						</view>
					</view>
					<view class="top-two">

						<view class="car-num fw-bold cl-333 fs-32 mr-rt10 flex flex-direction">
							<text class="mr-bt30">车牌号</text>
							<text>颜色</text>
						</view>
						<view class="img">
							<image src="../../../static/houb.png"></image>
						</view>
					</view>
				</view>
...
<script>
	export default {
		...
		methods: {
			...
			add() {
				uni.navigateTo({
					url: "/pages/index/perfectCarInfo"
				})
			},
			select(row) {
